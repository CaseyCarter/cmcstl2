...
STL2_OPEN_NAMESPACE {
  ...
  I partition_point(I first, S last, Pred pred_, Proj proj_ = Proj{}) {
    ...
    while (true) {
      ...
      if (m == last || !pred(proj(*m))) {
        n -= d;
        return __stl2::partition_point(__stl2::move(first), n, pred, proj);
      }
      first = __stl2::move(m);
      n *= 2;
    }
  ...
  I partition_point(I first, S last, Pred&& pred, Proj&& proj = Proj{}) {
    ...
    return __stl2::partition_point(__stl2::move(first), n,
  ...
  safe_iterator_t<Rng>
  partition_point(Rng&& rng, Pred&& pred, Proj&& proj = Proj{}) {
    return __stl2::partition_point(__stl2::begin(rng), __stl2::distance(rng),
      __stl2::forward<Pred>(pred), __stl2::forward<Proj>(proj));
  }
