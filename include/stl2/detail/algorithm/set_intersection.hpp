...
STL2_OPEN_NAMESPACE {
	struct __set_intersection_fn {
		...
		constexpr O operator()(I1 first1, S1 last1, I2 first2, S2 last2, O result,
		...
		constexpr O operator()(R1&& r1, R2&& r2, O result,
			Comp comp = Comp{}, Proj1 proj1 = Proj1{}, Proj2 proj2 = Proj2{}) const
		{
			return (*this)(__stl2::begin(r1), __stl2::end(r1),
				__stl2::begin(r2), __stl2::end(r2), std::forward<O>(result),
