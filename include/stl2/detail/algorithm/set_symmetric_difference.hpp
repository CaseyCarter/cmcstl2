...
STL2_OPEN_NAMESPACE {
  ...
  set_symmetric_difference(Rng1&& rng1, Rng2&& rng2,
  ...
  tagged_tuple<tag::in1(dangling<const E*>),
               tag::in2(safe_iterator_t<Rng2>), tag::out(__f<O>)>
  set_symmetric_difference(std::initializer_list<E>&& rng1, Rng2&& rng2,
                           O&& result, Comp&& comp = Comp{},
                           Proj1&& proj1 = Proj1{}, Proj2&& proj2 = Proj2{})
  {
    return __stl2::set_symmetric_difference(__stl2::begin(rng1), __stl2::end(rng1),
  ...
  set_symmetric_difference(Rng1&& rng1, std::initializer_list<E>&& rng2,
                           O&& result, Comp&& comp = Comp{},
                           Proj1&& proj1 = Proj1{}, Proj2&& proj2 = Proj2{})
  {
    return __stl2::set_symmetric_difference(__stl2::begin(rng1), __stl2::end(rng1),
