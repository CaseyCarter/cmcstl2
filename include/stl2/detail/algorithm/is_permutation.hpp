...
STL2_OPEN_NAMESPACE {
	...
	struct __is_permutation_fn : private __niebloid {
		...
		[[deprecated]] constexpr bool operator()(I1 first1, S1 last1, I2&& first2_, Pred pred = {},
		...
		[[deprecated]] constexpr bool operator()(R1&& r1, I2&& first2_, Pred pred = {},
			Proj1 proj1 = {}, Proj2 proj2 = {}) const
		requires
			ForwardIterator<std::decay_t<I2>> && !Range<I2> &&
			IndirectlyComparable<iterator_t<R1>, std::decay_t<I2>, Pred, Proj1, Proj2>
		{
			auto first2 = std::forward<I2>(first2_);
