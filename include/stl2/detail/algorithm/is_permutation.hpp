...
STL2_OPEN_NAMESPACE {
  ...
  [[deprecated]] bool
  is_permutation(I1 first1, S1 last1, I2 first2, Pred&& pred_ = Pred{},
  ...
  template<class E, ForwardRange Rng2, class Pred = equal_to<>,
           class Proj1 = identity, class Proj2 = identity>
  requires
    models::IndirectlyComparable<const E*, iterator_t<Rng2>,
                                 __f<Pred>, __f<Proj1>, __f<Proj2>>
  bool is_permutation(std::initializer_list<E>&& rng1, Rng2&& rng2,
                      Pred&& pred = Pred{},
                      Proj1&& proj1 = Proj1{}, Proj2&& proj2 = Proj2{})
  {
  ...
  template<ForwardRange Rng1, class E, class Pred = equal_to<>,
           class Proj1 = identity, class Proj2 = identity>
  requires
    models::IndirectlyComparable<iterator_t<Rng1>, const E*,
                                 __f<Pred>, __f<Proj1>, __f<Proj2>>
  bool is_permutation(Rng1&& rng1, std::initializer_list<E>&& rng2,
                      Pred&& pred = Pred{},
                      Proj1&& proj1 = Proj1{}, Proj2&& proj2 = Proj2{})
  {
    return __stl2::is_permutation(rng1, rng2,
  ...
  template<class E1, class E2, class Pred = equal_to<>,
           class Proj1 = identity, class Proj2 = identity>
  requires
    models::IndirectlyComparable<const E1*, const E2*,
                                 __f<Pred>, __f<Proj1>, __f<Proj2>>
  bool is_permutation(std::initializer_list<E1>&& rng1,
