...
STL2_OPEN_NAMESPACE {
  ...
  bool includes(I1 first1, S1 last1, I2 first2, S2 last2,
                Comp&& comp_ = Comp{},
  ...
  requires
    models::IndirectCallableStrictWeakOrder<__f<Comp>,
      ...
      projected<iterator_t<Rng2>, __f<Proj2>>>
  bool includes(std::initializer_list<E>&& rng1, Rng2&& rng2,
                Comp&& comp = Comp{},
                Proj1&& proj1 = Proj1{}, Proj2&& proj2 = Proj2{})
  {
    return __stl2::includes(
  ...
  bool includes(Rng1&& rng1, std::initializer_list<E>&& rng2,
                Comp&& comp = Comp{},
                Proj1&& proj1 = Proj1{}, Proj2&& proj2 = Proj2{})
  {
    return __stl2::includes(
