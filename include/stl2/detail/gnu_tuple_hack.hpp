...
namespace std _GLIBCXX_VISIBILITY(default) {
  ...
  protected:
    void _M_swap(_Tuple_impl &__in) noexcept(
        __is_nothrow_swappable<_Head>::value &&noexcept(
            _M_tail(__in)._M_swap(_M_tail(__in)))) {
      using std::swap;
  ...
  struct _Tuple_impl<_Idx, _Head> : private _Head_base<_Idx, _Head> {
    ...
    _Tuple_impl &operator=(_Tuple_impl &&__in) noexcept(
        is_nothrow_move_assignable<_Head>::value) {
      _M_head(*this) = std::forward<_Head>(_M_head(__in));
      return *this;
    }
  ...
  protected:
    void
    _M_swap(_Tuple_impl &__in) noexcept(__is_nothrow_swappable<_Head>::value) {
      using std::swap;
      swap(_M_head(*this), _M_head(__in));
    }
  };
  ...
  // constructors.
  template <bool, typename... _Elements> struct _TC {
    template <typename... _UElements>
    ...
    template <typename _SrcTuple> static constexpr bool _NonNestedTuple() {
    ...
    template <typename... _UElements> static constexpr bool _NotSameTuple() {
      return __not_<is_same<tuple<_Elements...>,
                            typename remove_const<typename remove_reference<
                                _UElements...>::type>::type>>::value;
    }
  };

  template <typename... _Elements> struct _TC<false, _Elements...> {
    template <typename... _UElements>
    static constexpr bool _ConstructibleTuple() {
      return false;
    }
    ...
    template <typename... _UElements> static constexpr bool _NonNestedTuple() {
      return true;
    }
    template <typename... _UElements> static constexpr bool _NotSameTuple() {
      return true;
  ...
  class tuple : public _Tuple_impl<0, _Elements...> {
    ...
    template <typename _Dummy> struct _TC2 {
      static constexpr bool _DefaultConstructibleTuple() {
        return __and_<is_default_constructible<_Elements>...>::value;
      }
      static constexpr bool _ImplicitlyDefaultConstructibleTuple() {
        return __and_<
            __is_implicitly_default_constructible<_Elements>...>::value;
      }
    };
  ...
  public:
    template <
        ...
        typename enable_if<_TC2<_Dummy>::_ImplicitlyDefaultConstructibleTuple(),
                           bool>::type = true>
    constexpr tuple() : _Inherited() {}

    template <typename _Dummy = void,
              typename enable_if<
                  _TC2<_Dummy>::_DefaultConstructibleTuple() &&
    ...
    template <typename _Dummy = void,
              typename enable_if<
                  _TCC<_Dummy>::template _ConstructibleTuple<_Elements...>() &&
                      _TCC<_Dummy>::template _ImplicitlyConvertibleTuple<
                          _Elements...>() &&
                      (sizeof...(_Elements) >= 1),
                  bool>::type = true>
    ...
    template <typename _Dummy>
    using _TNTC = _TC<is_same<_Dummy, void>::value && sizeof...(_Elements) == 1,
                      _Elements...>;
    ...
    template <
        typename _Alloc, typename... _UElements,
        typename enable_if<
            _TMC<_UElements...>::template _MoveConstructibleTuple<
                _UElements...>() &&
                _TMC<_UElements...>::template _ImplicitlyMoveConvertibleTuple<
    ...
    template <
        typename _Alloc, typename _Dummy = void, typename... _UElements,
        typename enable_if<
            _TMCT<_UElements...>::template _ConstructibleTuple<
                _UElements...>() &&
                _TMCT<_UElements...>::template _ImplicitlyConvertibleTuple<
    ...
    template <typename... _UElements>
    typename enable_if<sizeof...(_UElements) == sizeof...(_Elements),
                       tuple &>::type
    ...
    void swap(tuple &__in) noexcept(noexcept(__in._M_swap(__in))) {
	 ...
	 template<class... T2s, class Self, size_t... Is>
	 static constexpr tuple<T2s&&...> __make_tuple_reference(Self&& self, index_sequence<Is...>);

	 template<class... T2s, class Self>
	 requires sizeof...(_Elements) == sizeof...(T2s)
	 static constexpr auto __get_tuple_reference(Self&& self) noexcept;

	template<class... Us>
	requires sizeof...(_Elements) == sizeof...(Us) and
		(__stl2::Assignable<_Elements const&, Us const&> and ...)
  ...
  public:
    ...
    template <
        ...
        typename enable_if<
            _TMC::template _MoveConstructibleTuple<_U1, _U2>() &&
                ...
                !is_same<typename decay<_U1>::type, allocator_arg_t>::value,
            bool>::type = true>
    ...
    template <typename _U1, typename _U2,
              typename enable_if<
                  _TMC::template _ConstructibleTuple<_U1, _U2>() &&
    ...
    template <
        typename _Alloc, typename _Dummy = void,
        typename enable_if<
            _TCC<_Dummy>::template _ConstructibleTuple<_T1, _T2>() &&
                _TCC<_Dummy>::template _ImplicitlyConvertibleTuple<_T1, _T2>(),
            bool>::type = true>
    ...
    explicit tuple(allocator_arg_t __tag, const _Alloc &__a, const _T1 &__a1,
                   const _T2 &__a2)
        : _Inherited(__tag, __a, __a1, __a2) {}

    template <
        typename _Alloc, typename _U1, typename _U2,
        typename enable_if<
            _TMC::template _MoveConstructibleTuple<_U1, _U2>() &&
                _TMC::template _ImplicitlyMoveConvertibleTuple<_U1, _U2>(),
            bool>::type = true>
    ...
    template <
        ...
        typename enable_if<
            _TMC::template _MoveConstructibleTuple<_U1, _U2>() &&
                !_TMC::template _ImplicitlyMoveConvertibleTuple<_U1, _U2>(),
            bool>::type = false>
    explicit tuple(allocator_arg_t __tag, const _Alloc &__a, _U1 &&__a1,
                   _U2 &&__a2)
        : _Inherited(__tag, __a, std::forward<_U1>(__a1),
                     std::forward<_U2>(__a2)) {}
	...
	requires __stl2::Assignable<_T1 const&, _U1 const&> and
		__stl2::Assignable<_T2 const&, _U2 const&>
	static constexpr bool assignable_hack = true;

	constexpr tuple const& operator=(tuple<_T1, _T2> const&)
	requires __stl2::Assignable<_T1 const&, _T1 const&> and
		__stl2::Assignable<_T2 const&, _T2 const&>;

	constexpr tuple const& operator=(tuple<_T1, _T2>&&)
	requires __stl2::Assignable<_T1 const&, _T1> and __stl2::Assignable<_T2 const&, _T2>;

	template<class... Us>
	requires assignable_hack<Us...>
	tuple const& operator=(tuple<Us...> const& other) const;

	template<class... Us>
	requires assignable_hack<Us...>
	tuple const& operator=(tuple<Us...>&& other) const;
	...
	constexpr operator tuple<remove_reference_t<_T1>&, remove_reference_t<_T2>&>() noexcept;
	constexpr operator tuple<remove_reference_t<_T1> const&, remove_reference_t<_T2> const&>() const noexcept;
	constexpr operator tuple<remove_reference_t<_T1>&&, remove_reference_t<_T2>&&>() noexcept;
	constexpr operator tuple<remove_reference_t<_T1> const&&, remove_reference_t<_T2> const&&>() const noexcept;
  };
...
#define __cpp_lib_tuples_by_type 201304
  ...
  constexpr _Head &__get_helper2(_Tuple_impl<__i, _Head, _Tail...> &
                                 __t) noexcept {
    return _Tuple_impl<__i, _Head, _Tail...>::_M_head(__t);
  }

  template <typename _Head, size_t __i, typename... _Tail>
  constexpr const _Head &__get_helper2(
      const _Tuple_impl<__i, _Head, _Tail...> &__t) noexcept {
    return _Tuple_impl<__i, _Head, _Tail...>::_M_head(__t);
  }
...
#if __cplusplus > 201402L || !defined(__STRICT_ANSI__) // c++1z or gnu++11
  template <typename... _Elements>
  typename enable_if<!__and_<__is_swappable<_Elements>...>::value>::type swap(
  ...
  struct _Swallow_assign {
    template <class _Tp>
    _GLIBCXX14_CONSTEXPR const _Swallow_assign &operator=(const _Tp &) const {
      return *this;
    }
  };
...
#define __cpp_lib_make_from_tuple 201606
  ...
  /// @}
	...
	template<class... Ts>
	constexpr tuple<Ts...> const& tuple<Ts...>::operator=(tuple<Ts...> const&)
	requires (__stl2::Assignable<Ts const&, Ts const&> and ...)
	{ return *this; }

	template<class... Ts>
	constexpr tuple<Ts...> const& tuple<Ts...>::operator=(tuple<Ts...>&&)
	requires (__stl2::Assignable<Ts const&, Ts> and ...)
	{ return *this; }

	template<class... Ts>
	template<class... T2s, class Self, size_t... Is>
	constexpr tuple<T2s&&...> tuple<Ts...>::__make_tuple_reference(Self&& self, index_sequence<Is...>)
	{ return tuple<T2s&&...>{std::forward<T2s>(std::get<Is>(self))...}; }

	template<class... Ts>
	template<class... T2s, class Self>
	requires sizeof...(Ts) == sizeof...(T2s)
	constexpr auto tuple<Ts...>::__get_tuple_reference(Self&& self) noexcept
	{ return __make_tuple_reference<T2s&&...>(self, index_sequence_for<Ts...>{}); }

	template<class... Ts>
	constexpr tuple<Ts...>::operator tuple<remove_reference_t<Ts>&...>() noexcept
	{ return __get_tuple_reference<remove_reference_t<Ts>&...>(*this); }
	template<class... Ts>
	constexpr tuple<Ts...>::operator tuple<remove_reference_t<Ts> const&...>() const noexcept
	{ return __get_tuple_reference<remove_reference_t<Ts> const&...>(*this); }
	template<class... Ts>
	constexpr tuple<Ts...>::operator tuple<remove_reference_t<Ts>&&...>() noexcept
	{ return __get_tuple_reference<remove_reference_t<Ts>&&...>(*this); }
	template<class... Ts>
