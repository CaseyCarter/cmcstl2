...
void test_3(int N)
{
	...
	std::shuffle(ia, ia+N, gen);
	std::make_heap(ia, ia+N);
	CHECK(stl2::sort_heap(stl2::ext::subrange(ia, ia+N)) == ia+N);
	CHECK(std::is_sorted(ia, ia+N));
	delete [] ia;
}
...
void test_4(int N)
{
	...
	std::shuffle(ia, ia+N, gen);
	std::make_heap(ia, ia+N);
	CHECK(stl2::sort_heap(stl2::ext::subrange(ia, sentinel<int*>(ia+N))) == ia+N);
	CHECK(std::is_sorted(ia, ia+N));
	delete [] ia;
}
...
void test_7(int N)
{
	...
	std::shuffle(ia, ia+N, gen);
	std::make_heap(ia, ia+N, std::greater<int>());
	CHECK(stl2::sort_heap(stl2::ext::subrange(ia, ia+N), std::greater<int>()) == ia+N);
	CHECK(std::is_sorted(ia, ia+N, std::greater<int>()));
	delete [] ia;
}
...
void test_8(int N)
{
	...
	std::shuffle(ia, ia+N, gen);
	std::make_heap(ia, ia+N, std::greater<int>());
	CHECK(stl2::sort_heap(unref_view{stl2::ext::subrange(ia, sentinel<int*>(ia+N))}, std::greater<int>()).get_unsafe() == ia+N);
	CHECK(std::is_sorted(ia, ia+N, std::greater<int>()));
