...
int main()
{
    ...
    // Test rvalue ranges
    {
        ...
        auto res = stl2::set_difference(stl2::view::all(ia), stl2::view::all(ib), ic, std::less<int>(), &S::i, &T::j);
        ...
        int irr[] = {6};
        const int srr = sizeof(irr)/sizeof(irr[0]);
        auto res2 = stl2::set_difference(stl2::view::all(ib), stl2::view::all(ia), ic, std::less<int>(), &T::j, &S::i);
    ...
    // Test initializer list
    {
        ...
        std::pair<S *, U *> res = stl2::set_difference(
            ia,
            {T{2}, T{4}, T{4}, T{6}},
            ic,
        ...
        int irr[] = {6};
        const int srr = sizeof(irr)/sizeof(irr[0]);
        std::pair<T *, U *> res2 = stl2::set_difference(
            ib,
