...
void test_3(int N)
{
	...
	for (int i = N; i > 0; --i)
	{
		CHECK(stl2::pop_heap(unref_view{stl2::ext::subrange(ia, ia+i)}).get_unsafe() == ia+i);
		CHECK(std::is_heap(ia, ia+i-1));
	}
	CHECK(stl2::pop_heap(ia, ia) == ia);
	delete [] ia;
...
void test_4(int N)
{
	...
	for (int i = N; i > 0; --i)
	{
		CHECK(stl2::pop_heap(unref_view{stl2::ext::subrange(ia, sentinel<int*>(ia+i))}).get_unsafe() == ia+i);
		CHECK(std::is_heap(ia, ia+i-1));
	}
	CHECK(stl2::pop_heap(ia, ia) == ia);
	delete [] ia;
...
void test_7(int N)
{
	...
	for (int i = N; i > 0; --i)
	{
		CHECK(stl2::pop_heap(unref_view{stl2::ext::subrange(ia, ia+i)}, std::greater<int>()).get_unsafe() == ia+i);
		CHECK(std::is_heap(ia, ia+i-1, std::greater<int>()));
	}
	CHECK(stl2::pop_heap(ia, ia, std::greater<int>()) == ia);
	delete [] ia;
...
void test_8(int N)
{
	...
	for (int i = N; i > 0; --i)
	{
		CHECK(stl2::pop_heap(unref_view{stl2::ext::subrange(ia, sentinel<int*>(ia+i))}, std::greater<int>()).get_unsafe() == ia+i);
		CHECK(std::is_heap(ia, ia+i-1, std::greater<int>()));
	}
	CHECK(stl2::pop_heap(ia, sentinel<int*>(ia), std::greater<int>()) == ia);
	delete [] ia;
