...
namespace stl2
{
    ...
    struct common_type<sentinel<I0, S>, I1>
    {
      ...
      using type = void; //common_iterator<I1, sentinel<I0, S>>;
    };
    template<typename I0, typename I1, bool S>
    struct common_type<I0, sentinel<I1, S>>
    {
      // HACKHACKHACKHACKHACK
      using type = void; //common_iterator<I0, sentinel<I1, S>>;
    };
  ...
  template<typename I0, bool S, typename I1, template <typename> class TQual, template <typename> class UQual>
    struct basic_common_reference<sentinel<I0, S>, I1, TQual, UQual>
    {
      // HACKHACKHACKHACKHACK
      using type = void; //common_iterator<I1, sentinel<I0, S>>;
    };
  template<typename I0, typename I1, bool S, template <typename> class TQual, template <typename> class UQual>
    struct basic_common_reference<I0, sentinel<I1, S>, TQual, UQual>
    {
      // HACKHACKHACKHACKHACK
      using type = void; //common_iterator<I0, sentinel<I1, S>>;
    };
    template<typename I, bool B, template <typename> class TQual, template <typename> class UQual>
