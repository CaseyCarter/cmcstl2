...
public:
        ...
        checker<decltype(algo_(begin, end, rest...))>
    {
        ...
        return checker<R>{[=](std::function<void(R)> const & check)
        {
            ...
            check(algo_(::rvalue_if<RvalueOK>(__stl2::ext::make_range(begin, end)), rest...));
            check(algo_(::rvalue_if<RvalueOK>(__stl2::ext::make_range(begin, S{base(end)})), rest...));
        }};
    }
};
...
public:
        ...
        checker<decltype(algo_(begin1, end1, begin2, end2, rest...))>
    {
        ...
        return checker<R>{[=](std::function<void(R)> const & check)
        {
            ...
            check(algo_(::rvalue_if<RvalueOK1>(__stl2::ext::make_range(begin1, end1)),
                        ::rvalue_if<RvalueOK2>(__stl2::ext::make_range(begin2, end2)),
                        rest...));
            check(algo_(::rvalue_if<RvalueOK1>(__stl2::ext::make_range(begin1, S1{base(end1)})),
                        ::rvalue_if<RvalueOK2>(__stl2::ext::make_range(begin2, S2{base(end2)})),
                        rest...));
        }};
    }
};
